...
layout = html.Div([
        ...
        dbc.Row([
        dbc.Col([
            dcc.Graph(id='page9-line', config={'displayModeBar':False})
        ], width=12),
    ]),
        dbc.Row([
        dbc.Col([
        dcc.RangeSlider(id='page9-the_year',
                min=2000,
                max=2021,
                value=[2000,2021],
                marks=mark_values,
...
@callback(
    Output('page9-pais_elect', "value"),
    Output("store", "data"),
    Input('page9-pais_elect', "value"),
    State("store", "data"),
)
...
@callback(
    Output('page9-line', 'figure'),
    Input('page9-pais_elect', 'value'),
    Input('page9-comparacion_por_elect', 'value'),
    [Input('page9-the_year','value')]
)
