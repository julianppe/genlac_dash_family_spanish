...
dash.register_page(__name__,
                   path='/horas-actividades-cuidado',  # represents the url text
...
# page 1 data
df = pd.read_csv("datasets/hs_cuidado.csv")
...
layout = html.Div([
        ...
        dbc.Col([
            dcc.Dropdown(options=[{'label': x, 'value': x} for x in list_comparacion_por_ordenada], multi=False, persistence=True, persistence_type='memory', value='Ratio mujeres/hombres', id='page13-comparacion_por_elect')
        ], width=6),
    ]),
        dbc.Row([
        dbc.Col([
